...
logger = setup_logger('devrev_scraper')


class DevRevScraper:
    def __init__(self):
        self.company_name = 'DevRev'
        self.url = 'https://boards.greenhouse.io/devrev'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/devrev/jobs'
