...
logger = setup_logger('figma_scraper')


class FigmaScraper:
    def __init__(self):
        self.company_name = 'Figma'
        self.url = 'https://boards.greenhouse.io/figma'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/figma/jobs'
        ...
        try:
            ...
            for posting in postings:
                try:
                    ...
                    if not job_id:
                        job_id = f"figma_{hashlib.md5(title.encode()).hexdigest()[:12]}"
