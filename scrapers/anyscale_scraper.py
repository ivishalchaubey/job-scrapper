...
logger = setup_logger('anyscale_scraper')


class AnyscaleScraper:
    def __init__(self):
        self.company_name = 'Anyscale'
        self.api_url = 'https://api.ashbyhq.com/posting-api/job-board/anyscale'
        ...
        try:
            ...
            for job in jobs:
                try:
                    ...
                    # Fallback: parse from location string (e.g., "Bengaluru, Karnataka")
