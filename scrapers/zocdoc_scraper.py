...
logger = setup_logger('zocdoc_scraper')


class ZocdocScraper:
    def __init__(self):
        self.company_name = 'Zocdoc'
        self.url = 'https://boards.greenhouse.io/zocdoc'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/zocdoc/jobs'
