...
logger = setup_logger('commvault_scraper')


class CommvaultScraper:
    def __init__(self):
        self.company_name = 'Commvault'
        self.url = 'https://boards.greenhouse.io/commvault'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/commvault/jobs'
