...
logger = setup_logger('oportun_scraper')


class OportunScraper:
    def __init__(self):
        self.company_name = 'Oportun'
        self.url = 'https://boards.greenhouse.io/oportun'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/oportun/jobs'
