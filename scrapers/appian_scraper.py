...
logger = setup_logger('appian_scraper')


class AppianScraper:
    def __init__(self):
        self.company_name = 'Appian'
        self.url = 'https://boards.greenhouse.io/appian'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/appian/jobs'
