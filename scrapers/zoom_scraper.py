...
logger = setup_logger('zoom_scraper')


class ZoomScraper:
    def __init__(self):
        self.company_name = 'Zoom'
        self.url = 'https://zoom.wd5.myworkdayjobs.com/Zoom'
        self.api_url = 'https://zoom.wd5.myworkdayjobs.com/wday/cxs/zoom/Zoom/jobs'
        self.base_job_url = 'https://zoom.wd5.myworkdayjobs.com/Zoom'
