...
logger = setup_logger('zenoti_scraper')


class ZenotiScraper:
    def __init__(self):
        self.company_name = 'Zenoti'
        self.url = 'https://boards.greenhouse.io/zenoti'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/zenoti/jobs'
