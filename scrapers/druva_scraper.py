...
logger = setup_logger('druva_scraper')


class DruvaScraper:
    def __init__(self):
        self.company_name = 'Druva'
        self.url = 'https://boards.greenhouse.io/druva'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/druva/jobs'
