...
logger = setup_logger('medtronic_scraper')


class MedtronicScraper:
    def __init__(self):
        self.company_name = 'Medtronic'
        self.url = 'https://medtronic.wd1.myworkdayjobs.com/MedtronicCareers'
        self.api_url = 'https://medtronic.wd1.myworkdayjobs.com/wday/cxs/medtronic/MedtronicCareers/jobs'
        self.base_job_url = 'https://medtronic.wd1.myworkdayjobs.com/MedtronicCareers'
