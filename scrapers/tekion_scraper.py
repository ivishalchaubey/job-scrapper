...
logger = setup_logger('tekion_scraper')


class TekionScraper:
    def __init__(self):
        self.company_name = 'Tekion'
        self.url = 'https://boards.greenhouse.io/tekion'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/tekion/jobs'
