...
logger = setup_logger('solarwinds_scraper')


class SolarWindsScraper:
    def __init__(self):
        self.company_name = 'SolarWinds'
        self.url = 'https://boards.greenhouse.io/solarwinds'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/solarwinds/jobs'
