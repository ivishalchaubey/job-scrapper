...
logger = setup_logger('hackerrank_scraper')


class HackerRankScraper:
    def __init__(self):
        self.company_name = 'HackerRank'
        self.url = 'https://boards.greenhouse.io/hackerrank'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/hackerrank/jobs'
