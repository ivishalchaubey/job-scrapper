...
logger = setup_logger('arcelormittal_scraper')


class ArcelorMittalScraper:
    def __init__(self):
        self.company_name = 'ArcelorMittal'
        self.url = 'https://emfg.fa.em4.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_4001/jobs'
        self.api_url = 'https://emfg.fa.em4.oraclecloud.com/hcmRestApi/resources/latest/recruitingCEJobRequisitions'
        self.site_number = 'CX_4001'
        self.page_size = 25
        self.job_detail_base_url = 'https://emfg.fa.em4.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_4001/job'
    ...
    def _parse_requisition(self, req):
        ...
        if 'remote' in workplace_type.lower():
            ...
            remote_type = 'On-site'
        employment_type = req.get('WorkerType', '') or req.get('ContractType', '') or ''
