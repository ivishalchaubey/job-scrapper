...
logger = setup_logger('workato_scraper')


class WorkatoScraper:
    def __init__(self):
        self.company_name = 'Workato'
        self.url = 'https://boards.greenhouse.io/workato'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/workato/jobs'
