...
logger = setup_logger('rubrik_scraper')


class RubrikScraper:
    def __init__(self):
        self.company_name = 'Rubrik'
        self.url = 'https://boards.greenhouse.io/rubrik'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/rubrik/jobs'
