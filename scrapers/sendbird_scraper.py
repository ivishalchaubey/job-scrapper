...
logger = setup_logger('sendbird_scraper')


class SendbirdScraper:
    def __init__(self):
        self.company_name = 'Sendbird'
        self.url = 'https://boards.greenhouse.io/sendbird'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/sendbird/jobs'
