...
logger = setup_logger('elastic_scraper')


class ElasticScraper:
    def __init__(self):
        self.company_name = 'Elastic'
        self.url = 'https://boards.greenhouse.io/elastic'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/elastic/jobs'
