...
logger = setup_logger('onetrust_scraper')


class OneTrustScraper:
    def __init__(self):
        self.company_name = 'OneTrust'
        self.url = 'https://boards.greenhouse.io/onetrust'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/onetrust/jobs'
