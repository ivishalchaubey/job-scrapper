...
logger = setup_logger('binance_scraper')


class BinanceScraper:
    def __init__(self):
        self.company_name = 'Binance'
        self.url = 'https://jobs.lever.co/binance'
        self.api_url = 'https://api.lever.co/v0/postings/binance?mode=json'
