...
logger = setup_logger('leidos_scraper')


class LeidosScraper:
    def __init__(self):
        self.company_name = 'Leidos'
        self.url = 'https://leidos.wd5.myworkdayjobs.com/External'
        self.api_url = 'https://leidos.wd5.myworkdayjobs.com/wday/cxs/leidos/External/jobs'
        self.base_job_url = 'https://leidos.wd5.myworkdayjobs.com/External'
