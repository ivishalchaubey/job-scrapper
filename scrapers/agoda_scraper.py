...
logger = setup_logger('agoda_scraper')


class AgodaScraper:
    def __init__(self):
        self.company_name = 'Agoda'
        self.url = 'https://boards.greenhouse.io/agoda'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/agoda/jobs'
