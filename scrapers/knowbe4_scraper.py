...
logger = setup_logger('knowbe4_scraper')


class KnowBe4Scraper:
    def __init__(self):
        self.company_name = 'KnowBe4'
        self.url = 'https://boards.greenhouse.io/knowbe4'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/knowbe4/jobs'
