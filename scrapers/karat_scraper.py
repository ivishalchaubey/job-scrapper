...
logger = setup_logger('karat_scraper')


class KaratScraper:
    def __init__(self):
        self.company_name = 'Karat'
        self.url = 'https://boards.greenhouse.io/karat'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/karat/jobs'
