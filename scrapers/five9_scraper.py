...
logger = setup_logger('five9_scraper')


class Five9Scraper:
    def __init__(self):
        self.company_name = 'Five9'
        self.url = 'https://boards.greenhouse.io/five9'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/five9/jobs'
