...
logger = setup_logger('biofourmis_scraper')


class BiofourmisScraper:
    def __init__(self):
        self.company_name = 'Biofourmis'
        self.url = 'https://boards.greenhouse.io/biofourmis'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/biofourmis/jobs'
