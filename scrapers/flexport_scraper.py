...
logger = setup_logger('flexport_scraper')


class FlexportScraper:
    def __init__(self):
        self.company_name = 'Flexport'
        self.url = 'https://boards.greenhouse.io/flexport'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/flexport/jobs'
