...
logger = setup_logger('cloudsek_scraper')


class CloudSEKScraper:
    def __init__(self):
        self.company_name = 'CloudSEK'
        self.url = 'https://boards.greenhouse.io/cloudsek'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/cloudsek/jobs'
