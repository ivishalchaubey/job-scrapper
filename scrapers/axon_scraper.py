...
logger = setup_logger('axon_scraper')


class AxonScraper:
    def __init__(self):
        self.company_name = 'Axon'
        self.url = 'https://boards.greenhouse.io/axon'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/axon/jobs'
