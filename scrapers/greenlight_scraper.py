...
logger = setup_logger('greenlight_scraper')


class GreenlightScraper:
    def __init__(self):
        self.company_name = 'Greenlight'
        self.url = 'https://jobs.lever.co/greenlight'
        self.api_url = 'https://api.lever.co/v0/postings/greenlight?mode=json'
