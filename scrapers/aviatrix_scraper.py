...
logger = setup_logger('aviatrix_scraper')


class AviatrixScraper:
    def __init__(self):
        self.company_name = 'Aviatrix'
        self.url = 'https://boards.greenhouse.io/aviatrix'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/aviatrix/jobs'
