...
logger = setup_logger('zscaler_scraper')


class ZscalerScraper:
    def __init__(self):
        self.company_name = 'Zscaler'
        self.url = 'https://boards.greenhouse.io/zscaler'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/zscaler/jobs'
        ...
        try:
            ...
            for posting in postings:
                try:
                    ...
                    # Avoid false positives like "Indiana, USA"
                    loc_lower = location.lower()
                    if 'indiana' in loc_lower:
                        is_india = False
                    else:
                        is_india = any(kw in location for kw in india_keywords)
                    if not is_india:
                        continue
