...
logger = setup_logger('twilio_scraper')


class TwilioScraper:
    def __init__(self):
        self.company_name = 'Twilio'
        self.url = 'https://boards.greenhouse.io/twilio'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/twilio/jobs'
