...
logger = setup_logger('duolingo_scraper')


class DuolingoScraper:
    def __init__(self):
        self.company_name = 'Duolingo'
        self.url = 'https://boards.greenhouse.io/duolingo'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/duolingo/jobs'
        ...
        try:
            ...
            for posting in postings:
                try:
                    ...
                    if not job_id:
                        job_id = f"duolingo_{hashlib.md5(title.encode()).hexdigest()[:12]}"
