...
logger = setup_logger('ivalua_scraper')


class IvaluaScraper:
    def __init__(self):
        self.company_name = 'Ivalua'
        self.url = 'https://boards.greenhouse.io/ivalua'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/ivalua/jobs'
