...
logger = setup_logger('blueshift_scraper')


class BlueshiftScraper:
    def __init__(self):
        self.company_name = 'Blueshift'
        self.url = 'https://boards.greenhouse.io/blueshift'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/blueshift/jobs'
