...
logger = setup_logger('plume_scraper')


class PlumeScraper:
    def __init__(self):
        self.company_name = 'Plume'
        self.url = 'https://boards.greenhouse.io/plume'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/plume/jobs'
