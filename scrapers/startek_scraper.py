...
logger = setup_logger('startek_scraper')
...
class StartekScraper:
    def __init__(self):
        ...
        self.page_size = 25
        self.job_detail_base_url = 'https://fa-evuf-saasfaprod1.fa.ocs.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1/job'
        ...
        try:
            ...
            while current_page < max_pages:
                ...
                finder = (
                    ...
                    f'selectedLocationsFacet={self.india_location_ids},'
