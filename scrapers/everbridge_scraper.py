...
logger = setup_logger('everbridge_scraper')


class EverbridgeScraper:
    def __init__(self):
        self.company_name = 'Everbridge'
        self.url = 'https://jobs.lever.co/everbridge'
        self.api_url = 'https://api.lever.co/v0/postings/everbridge?mode=json'
