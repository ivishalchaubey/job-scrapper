...
logger = setup_logger('logicmonitor_scraper')


class LogicMonitorScraper:
    def __init__(self):
        self.company_name = 'LogicMonitor'
        self.url = 'https://boards.greenhouse.io/logicmonitor'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/logicmonitor/jobs'
