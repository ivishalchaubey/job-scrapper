...
logger = setup_logger('vonage_scraper')


class VonageScraper:
    def __init__(self):
        self.company_name = 'Vonage'
        self.url = 'https://boards.greenhouse.io/vonage'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/vonage/jobs'
