...
logger = setup_logger('backblaze_scraper')


class BackblazeScraper:
    def __init__(self):
        self.company_name = 'Backblaze'
        self.url = 'https://boards.greenhouse.io/backblaze'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/backblaze/jobs'
