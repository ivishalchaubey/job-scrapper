...
logger = setup_logger('datadog_scraper')


class DatadogScraper:
    def __init__(self):
        self.company_name = 'Datadog'
        self.url = 'https://boards.greenhouse.io/datadog'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/datadog/jobs'
