...
logger = setup_logger('postman_scraper')


class PostmanScraper:
    def __init__(self):
        self.company_name = 'Postman'
        self.url = 'https://boards.greenhouse.io/postman'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/postman/jobs'
