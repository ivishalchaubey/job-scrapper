...
logger = setup_logger('narvar_scraper')


class NarvarScraper:
    def __init__(self):
        self.company_name = 'Narvar'
        self.url = 'https://boards.greenhouse.io/narvar'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/narvar/jobs'
