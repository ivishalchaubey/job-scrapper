...
logger = setup_logger('highradius_scraper')


class HighRadiusScraper:
    def __init__(self):
        self.company_name = 'HighRadius'
        self.url = 'https://boards.greenhouse.io/highradius'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/highradius/jobs'
