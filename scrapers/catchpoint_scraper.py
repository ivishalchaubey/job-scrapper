...
logger = setup_logger('catchpoint_scraper')


class CatchpointScraper:
    def __init__(self):
        self.company_name = 'Catchpoint'
        self.url = 'https://boards.greenhouse.io/catchpoint'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/catchpoint/jobs'
