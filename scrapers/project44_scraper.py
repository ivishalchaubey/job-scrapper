...
logger = setup_logger('project44_scraper')


class Project44Scraper:
    def __init__(self):
        self.company_name = 'Project44'
        self.url = 'https://boards.greenhouse.io/project44'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/project44/jobs'
