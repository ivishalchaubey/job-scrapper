...
logger = setup_logger('suki_scraper')


class SukiScraper:
    def __init__(self):
        self.company_name = 'Suki'
        self.url = 'https://boards.greenhouse.io/suki'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/suki/jobs'
