...
logger = setup_logger('smartbear_scraper')


class SmartBearScraper:
    def __init__(self):
        self.company_name = 'SmartBear'
        self.url = 'https://boards.greenhouse.io/smartbear'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/smartbear/jobs'
