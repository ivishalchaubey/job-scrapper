...
logger = setup_logger('justanswer_scraper')


class JustAnswerScraper:
    def __init__(self):
        self.company_name = 'JustAnswer'
        self.url = 'https://boards.greenhouse.io/justanswer'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/justanswer/jobs'
