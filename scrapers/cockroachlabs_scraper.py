...
logger = setup_logger('cockroachlabs_scraper')


class CockroachLabsScraper:
    def __init__(self):
        self.company_name = 'Cockroach Labs'
        self.url = 'https://boards.greenhouse.io/cockroachlabs'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/cockroachlabs/jobs'
