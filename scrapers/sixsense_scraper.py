...
logger = setup_logger('sixsense_scraper')


class SixSenseScraper:
    def __init__(self):
        self.company_name = '6sense'
        self.url = 'https://boards.greenhouse.io/6sense'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/6sense/jobs'
