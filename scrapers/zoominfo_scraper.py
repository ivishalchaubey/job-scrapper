...
logger = setup_logger('zoominfo_scraper')


class ZoomInfoScraper:
    def __init__(self):
        self.company_name = 'ZoomInfo'
        self.url = 'https://boards.greenhouse.io/zoominfo'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/zoominfo/jobs'
