...
logger = setup_logger('yugabyte_scraper')


class YugabyteScraper:
    def __init__(self):
        self.company_name = 'Yugabyte'
        self.url = 'https://boards.greenhouse.io/yugabyte'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/yugabyte/jobs'
