...
logger = setup_logger('zuora_scraper')


class ZuoraScraper:
    def __init__(self):
        self.company_name = 'Zuora'
        self.url = 'https://boards.greenhouse.io/zuora'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/zuora/jobs'
