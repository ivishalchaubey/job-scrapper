...
logger = setup_logger('groww_scraper')


class GrowwScraper:
    def __init__(self):
        self.company_name = 'Groww'
        self.url = 'https://boards.greenhouse.io/groww'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/groww/jobs'
