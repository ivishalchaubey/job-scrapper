...
logger = setup_logger('spotify_scraper')


class SpotifyScraper:
    def __init__(self):
        self.company_name = 'Spotify'
        self.url = 'https://jobs.lever.co/spotify'
        self.api_url = 'https://api.lever.co/v0/postings/spotify?mode=json'
