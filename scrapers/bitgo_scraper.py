...
logger = setup_logger('bitgo_scraper')


class BitGoScraper:
    def __init__(self):
        self.company_name = 'BitGo'
        self.url = 'https://boards.greenhouse.io/bitgo'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/bitgo/jobs'
