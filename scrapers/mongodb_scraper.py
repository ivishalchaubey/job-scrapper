...
logger = setup_logger('mongodb_scraper')


class MongoDBScraper:
    def __init__(self):
        self.company_name = 'MongoDB'
        self.url = 'https://boards.greenhouse.io/mongodb'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/mongodb/jobs'
