...
logger = setup_logger('quince_scraper')


class QuinceScraper:
    def __init__(self):
        self.company_name = 'Quince'
        self.url = 'https://boards.greenhouse.io/quince'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/quince/jobs'
