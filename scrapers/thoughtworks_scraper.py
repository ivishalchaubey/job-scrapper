...
logger = setup_logger('thoughtworks_scraper')


class ThoughtworksScraper:
    def __init__(self):
        self.company_name = 'Thoughtworks'
        self.url = 'https://boards.greenhouse.io/thoughtworks'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/thoughtworks/jobs'
