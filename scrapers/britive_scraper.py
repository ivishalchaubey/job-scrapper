...
logger = setup_logger('britive_scraper')


class BritiveScraper:
    def __init__(self):
        self.company_name = 'Britive'
        self.url = 'https://boards.greenhouse.io/britive'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/britive/jobs'
