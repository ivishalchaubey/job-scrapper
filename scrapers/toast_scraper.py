...
logger = setup_logger('toast_scraper')


class ToastScraper:
    def __init__(self):
        self.company_name = 'Toast'
        self.url = 'https://boards.greenhouse.io/toast'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/toast/jobs'
