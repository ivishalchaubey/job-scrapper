...
logger = setup_logger('abnormalsecurity_scraper')


class AbnormalSecurityScraper:
    def __init__(self):
        self.company_name = 'Abnormal Security'
        self.url = 'https://boards.greenhouse.io/abnormalsecurity'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/abnormalsecurity/jobs'
