...
logger = setup_logger('minio_scraper')


class MinIOScraper:
    def __init__(self):
        self.company_name = 'MinIO'
        self.url = 'https://boards.greenhouse.io/minio'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/minio/jobs'
