...
logger = setup_logger('falconx_scraper')


class FalconXScraper:
    def __init__(self):
        self.company_name = 'FalconX'
        self.url = 'https://boards.greenhouse.io/falconx'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/falconx/jobs'
