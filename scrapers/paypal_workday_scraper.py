...
logger = setup_logger('paypal_workday_scraper')
            ...
            while page < max_pages:
                ...
                for posting in job_postings:
                    try:
                        ...
                        # Filter by India location since searchText approach may return non-India jobs
                        india_keywords = ['India', 'Bangalore', 'Bengaluru', 'Mumbai', 'Delhi', 'Hyderabad', 'Chennai', 'Pune', 'Gurugram', 'Gurgaon', 'Noida', 'Kolkata']
