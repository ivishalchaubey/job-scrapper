...
logger = setup_logger('coupang_scraper')


class CoupangScraper:
    def __init__(self):
        self.company_name = 'Coupang'
        self.url = 'https://boards.greenhouse.io/coupang'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/coupang/jobs'
