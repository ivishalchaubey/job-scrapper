...
logger = setup_logger('singlestore_scraper')


class SingleStoreScraper:
    def __init__(self):
        self.company_name = 'SingleStore'
        self.url = 'https://boards.greenhouse.io/singlestore'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/singlestore/jobs'
