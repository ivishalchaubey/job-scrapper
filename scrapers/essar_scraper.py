...
logger = setup_logger('essar_scraper')
...
class EssarGroupScraper:
    def __init__(self):
        ...
        self.page_size = 25
        self.job_detail_base_url = 'https://ekjy.fa.em2.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_3007/job'
