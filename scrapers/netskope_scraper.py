...
logger = setup_logger('netskope_scraper')


class NetskopeScraper:
    def __init__(self):
        self.company_name = 'Netskope'
        self.url = 'https://boards.greenhouse.io/netskope'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/netskope/jobs'
