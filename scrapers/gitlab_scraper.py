...
logger = setup_logger('gitlab_scraper')


class GitLabScraper:
    def __init__(self):
        self.company_name = 'GitLab'
        self.url = 'https://boards.greenhouse.io/gitlab'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/gitlab/jobs'
