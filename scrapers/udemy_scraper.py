...
logger = setup_logger('udemy_scraper')


class UdemyScraper:
    def __init__(self):
        self.company_name = 'Udemy'
        self.url = 'https://boards.greenhouse.io/udemy'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/udemy/jobs'
