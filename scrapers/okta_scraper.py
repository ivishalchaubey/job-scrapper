...
logger = setup_logger('okta_scraper')


class OktaScraper:
    def __init__(self):
        self.company_name = 'Okta'
        self.url = 'https://boards.greenhouse.io/okta'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/okta/jobs'
