...
logger = setup_logger('fivetran_scraper')


class FivetranScraper:
    def __init__(self):
        self.company_name = 'Fivetran'
        self.url = 'https://boards.greenhouse.io/fivetran'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/fivetran/jobs'
