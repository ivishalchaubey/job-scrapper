...
logger = setup_logger('bloomreach_scraper')


class BloomreachScraper:
    def __init__(self):
        self.company_name = 'Bloomreach'
        self.url = 'https://boards.greenhouse.io/bloomreach'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/bloomreach/jobs'
