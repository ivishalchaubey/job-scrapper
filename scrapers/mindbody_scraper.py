...
logger = setup_logger('mindbody_scraper')


class MindbodyScraper:
    def __init__(self):
        self.company_name = 'Mindbody'
        self.url = 'https://boards.greenhouse.io/mindbody'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/mindbody/jobs'
