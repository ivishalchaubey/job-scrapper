...
logger = setup_logger('fastly_scraper')


class FastlyScraper:
    def __init__(self):
        self.company_name = 'Fastly'
        self.url = 'https://boards.greenhouse.io/fastly'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/fastly/jobs'
