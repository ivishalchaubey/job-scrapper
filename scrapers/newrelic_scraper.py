...
logger = setup_logger('newrelic_scraper')


class NewRelicScraper:
    def __init__(self):
        self.company_name = 'New Relic'
        self.url = 'https://boards.greenhouse.io/newrelic'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/newrelic/jobs'
