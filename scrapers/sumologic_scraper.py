...
logger = setup_logger('sumologic_scraper')


class SumoLogicScraper:
    def __init__(self):
        self.company_name = 'Sumo Logic'
        self.url = 'https://boards.greenhouse.io/sumologic'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/sumologic/jobs'
