...
logger = setup_logger('appdirect_scraper')


class AppDirectScraper:
    def __init__(self):
        self.company_name = 'AppDirect'
        self.url = 'https://boards.greenhouse.io/appdirect'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/appdirect/jobs'
