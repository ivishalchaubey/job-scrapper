...
logger = setup_logger('starburst_scraper')


class StarburstScraper:
    def __init__(self):
        self.company_name = 'Starburst'
        self.url = 'https://boards.greenhouse.io/starburst'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/starburst/jobs'
