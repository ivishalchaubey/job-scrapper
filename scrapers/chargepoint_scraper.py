...
logger = setup_logger('chargepoint_scraper')


class ChargePointScraper:
    def __init__(self):
        self.company_name = 'ChargePoint'
        self.url = 'https://boards.greenhouse.io/chargepoint'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/chargepoint/jobs'
