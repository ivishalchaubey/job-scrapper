...
logger = setup_logger('dialpad_scraper')


class DialpadScraper:
    def __init__(self):
        self.company_name = 'Dialpad'
        self.url = 'https://boards.greenhouse.io/dialpad'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/dialpad/jobs'
