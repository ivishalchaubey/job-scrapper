...
logger = setup_logger('turing_scraper')


class TuringScraper:
    def __init__(self):
        self.company_name = 'Turing'
        self.url = 'https://boards.greenhouse.io/turing'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/turing/jobs'
