...
class TencentScraper:
    def __init__(self):
        ...
        self.url = 'https://tencent.wd1.myworkdayjobs.com/Tencent_Careers'
        self.api_url = 'https://tencent.wd1.myworkdayjobs.com/wday/cxs/tencent/Tencent_Careers/jobs'
        self.base_job_url = 'https://tencent.wd1.myworkdayjobs.com/Tencent_Careers'
                    ...
                    try:
                        ...
                        if external_path:
                            ...
                            if parts:
                                job_id = parts[-1]
                        if not job_id:
                            job_id = f"tencent_{hashlib.md5(title.encode()).hexdigest()[:12]}"
