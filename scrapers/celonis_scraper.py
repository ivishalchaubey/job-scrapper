...
logger = setup_logger('celonis_scraper')


class CelonisScraper:
    def __init__(self):
        self.company_name = 'Celonis'
        self.url = 'https://boards.greenhouse.io/celonis'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/celonis/jobs'
