...
logger = setup_logger('kaseya_scraper')


class KaseyaScraper:
    def __init__(self):
        self.company_name = 'Kaseya'
        self.url = 'https://boards.greenhouse.io/kaseya'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/kaseya/jobs'
