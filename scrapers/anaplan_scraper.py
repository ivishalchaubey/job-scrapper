...
logger = setup_logger('anaplan_scraper')


class AnaplanScraper:
    def __init__(self):
        self.company_name = 'Anaplan'
        self.url = 'https://boards.greenhouse.io/anaplan'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/anaplan/jobs'
