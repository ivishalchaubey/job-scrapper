...
logger = setup_logger('instabase_scraper')


class InstabaseScraper:
    def __init__(self):
        self.company_name = 'Instabase'
        self.url = 'https://boards.greenhouse.io/instabase'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/instabase/jobs'
