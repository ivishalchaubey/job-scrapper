...
logger = setup_logger('bloomenergy_scraper')


class BloomEnergyScraper:
    def __init__(self):
        self.company_name = 'Bloom Energy'
        self.url = 'https://bloomenergy.wd1.myworkdayjobs.com/BloomEnergyCareers?locationCountry=c4f78be1a8f14da0ab49ce1162348a5e'
        self.api_url = 'https://bloomenergy.wd1.myworkdayjobs.com/wday/cxs/bloomenergy/BloomEnergyCareers/jobs'
        self.base_job_url = 'https://bloomenergy.wd1.myworkdayjobs.com/BloomEnergyCareers'
                    ...
                    try:
                        ...
                        if external_path:
                            ...
                            if parts:
                                job_id = parts[-1]
                        if not job_id:
                            job_id = f"bloomenergy_{hashlib.md5(title.encode()).hexdigest()[:12]}"
