...
logger = setup_logger('fictiv_scraper')


class FictivScraper:
    def __init__(self):
        self.company_name = 'Fictiv'
        self.url = 'https://boards.greenhouse.io/fictiv'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/fictiv/jobs'
