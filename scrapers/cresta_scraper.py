...
logger = setup_logger('cresta_scraper')


class CrestaScraper:
    def __init__(self):
        self.company_name = 'Cresta'
        self.url = 'https://boards.greenhouse.io/cresta'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/cresta/jobs'
