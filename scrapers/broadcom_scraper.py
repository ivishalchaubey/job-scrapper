...
logger = setup_logger('broadcom_scraper')


class BroadcomScraper:
    def __init__(self):
        self.company_name = 'Broadcom'
        self.url = 'https://broadcom.wd1.myworkdayjobs.com/External_Career?locationCountry=c4f78be1a8f14da0ab49ce1162348a5e'
        self.api_url = 'https://broadcom.wd1.myworkdayjobs.com/wday/cxs/broadcom/External_Career/jobs'
        self.base_job_url = 'https://broadcom.wd1.myworkdayjobs.com/External_Career'
                    ...
                    try:
                        ...
                        if external_path:
                            ...
                            if parts:
                                job_id = parts[-1]
                        if not job_id:
                            job_id = f"broadcom_{hashlib.md5(title.encode()).hexdigest()[:12]}"
