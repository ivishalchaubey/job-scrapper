...
logger = setup_logger('cision_scraper')


class CisionScraper:
    def __init__(self):
        self.company_name = 'Cision'
        self.url = 'https://boards.greenhouse.io/cision'
        self.api_url = 'https://boards-api.greenhouse.io/v1/boards/cision/jobs'
